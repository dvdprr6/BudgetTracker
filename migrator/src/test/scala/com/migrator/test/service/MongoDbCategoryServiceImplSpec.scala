    ...
    suite("Mongo Database Category Service Implementation Spec")(
      test("MongoDbCategoryServiceImpl should return successfully"){
        val expected: Seq[Category] = Seq(
          Category(new ObjectId("6619081b309f7e198f6dd3eb"), "Groceries", Utils.stringToDate("2024-04-11 06:42:51"), Utils.stringToDate("2024-04-11 06:42:51")),
          Category(new ObjectId("6619082a309f7e198f6dd3ec"), "parking", Utils.stringToDate("2024-04-11 06:42:51"), Utils.stringToDate("2024-04-11 06:42:51")),
          Category(new ObjectId("66190831309f7e198f6dd3ed"), "salary", Utils.stringToDate("2024-04-11 06:42:51"), Utils.stringToDate("2024-04-11 06:42:51"))
        )

        val mongoDbConnectionMock = MongoDbConnectionMock.GetMongoRecords.of[(String, String, Class[Category]), Exception, Seq[Category]](
          equalTo(("mongoUrl", "categories", classOf[Category])),
          value(expected)
        )

        val testRun = for{
          mongoDbCategoryRepository <- ZIO.service[MongoDbCategoryRepository]
          category <- mongoDbCategoryRepository.getCategoryRecords("mongoUrl")
